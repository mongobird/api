            ...
            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="body">
                            <ul class="nav nav-tabs-new">
                                <li class="nav-item mr-1"><a class="nav-link" v-on:click="setActive('Overview')" href="#"  :class="{ active:isActive('Overview') }">Overview</a></li>
                                <li class="nav-item"><a class="nav-link" v-on:click="setActive('Settings')" href="#" :class="{ active:isActive('Settings') }">Settings</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="tab-content padding-0">
                        <div class="tab-pane" id="Overview" :class="{ active:isActive('Overview') }">
                            <new-post></new-post>
                        ...
                        <div class="tab-pane" id="Settings" :class="{ active:isActive('Settings') }">
                            <div class="card">
                                <div class="body">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <datepicker class="form-control" :bootstrap-styling="true" placeholder="Birthdate" ></datepicker>
                                                </div>
                                            </div>
                                            <div class="form-group">
                ...
                <div class="col-lg-3 col-md-12">
                    ...
                    <div class="row clearfix text-center">
                        <div class="col-12" v-for="(option,index) in knobOptionDetail" :key="index">
                            <div class="card">
                                <div class="body">
                                    <vue-circle-control-slider
                                        ...
                                        :progressWidth="4"
                                        :circleWidth="4"
                                        :progressColor="option.progressColor"
                                        :dialTextColor="option.progressColor"
                                        circleColor="#eeeeee"
                                    />
                                    <h6>Events</h6>
    ...
    components: {
        ...
        return{
            ...
            [
                {
                    title : 'Events',
                    sub_title : "12 of this month",
                    value : 22,
                    progressColor :"#61c6b6",
                },
                {
                    title : 'Birthday',
                    sub_title : "12 of this month",
                    value: 80,
                    progressColor:"#4d97f3",
                },
                {
                    title : 'Conferences',
                    sub_title : "12 of this month",
                    value: 66,
                    progressColor:"#e74133",
                },
                {
                    title : 'Seminars',
                    sub_title : "12 of this month",
                    value: 50,
                    progressColor:"#53af50",
                },
            ],
        }
    },methods:{
